# scafctl-plugin-directory - AI Agent Instructions

## Overview

scafctl provider plugin implementing the **directory** provider.

## Key Patterns

- **Plugin SDK**: Uses `github.com/oakwood-commons/scafctl-plugin-sdk`
- **Entry point**: `cmd/scafctl-plugin-directory/main.go` calls `sdkplugin.Serve()`
